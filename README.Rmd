...
:dart: Functions to procedurally generate synthetic data in R for kidney transplant simulations. You can see `simK` in action, [here](https://simk.netlify.app/).
...
A detailed description of these functions usage, is available from [here](https://simk.netlify.app/articles/simk.html).
